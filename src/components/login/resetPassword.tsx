                    ...
                    <div className='flex flex-col mt-4 w-w-4/4'>
                        <form onSubmit={handleSubmit(onSubmit)}>
                            <div className='flex flex-col gap-y-2 mt-4 '>
                                ...
                                <input type="email" {...register("email")} className='h-12 rounded-md border-2 outline-none p-2' required={true} />
                                {errors.email && <span>This field is required</span>}
                            </div>
                            <input type="submit" name='Reset Password' className='mt-5 rounded-sm border-0 login-btn cursor-pointer' />
                        </form>
