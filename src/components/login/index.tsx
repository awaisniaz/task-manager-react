                    ...
                    <div className='flex flex-col mt-4 w-w-4/4'>
                        <form onSubmit={handleSubmit(onSubmit)}>
                            <div className='flex flex-col gap-y-2 mt-4 '>
                                <div className='flex justify-between items-center'><p>Login</p></div>
                            ...
                            <div className='flex flex-col gap-y-2 mt-4 '>
                                <div className='flex justify-between items-center'><p>Password</p><a href='#' className='text-gray-500 font-bold text-sm'>Forget Password</a> </div>
                            ...
                            <input type="submit" className='mt-5 rounded-sm border-0 login-btn cursor-pointer' />
                        </form>
